    ...
    <>
      ...
      <div className="px-8 sm:px-16 md:px-28 lg:px-36 py-8 md:py-14 lg:py-20 font-gotham text-justify">
        <section>
          ...
          <p className="text-mingor-text-blue font-light text-xs md:text-base lg:text-xl mt-3">
            Frozen Musical - 2018
          </p>
        </section>
        <section className="my-16 sm:my-20 md:my-28 lg:my-40">
          <h1 className="font-bitcheese text-center text-mingor-text-blue font-normal text-4xl sm:text-5xl md:text-7xl lg:text-8xl">
            Gayang Mingor?
          </h1>
